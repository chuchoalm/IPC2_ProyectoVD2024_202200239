...
from estructuras.matrizDispersa.listaCabecera import ListaCabecera
from estructuras.matrizDispersa.nodoCabecera import NodoCabecera
from estructuras.matrizDispersa.nodoCelda import NodoCelda
